...
-   As Makofane did [-@makofane2021], one can test for this violation using linear models.

-   If you detect spillover, you need to do the coding estimator described in [@tchetgentchetgen2020] which involves thinning the dataset.
