...
In addition to the Person–Place Network Mapper, we piloted an optional **Link Tracer** feature designed to support anonymous chain-referral recruitment. After completing the survey, participants were invited to share a pre-written message containing a study link with recent friends or partners using their own phones or messaging apps. This design ensured that the study platform never accessed or stored phone numbers, email addresses, usernames, or any other identifying information.


![](_const/images/link_tracer.png){fig-align="center" width="492"}

Uptake was low: **fewer than five people used the referral feature during the study period**. In keeping with our privacy protections and data-governance commitments—and because such a small number could not support meaningful analysis—we **discarded these data**. No link-tracing information is included in the analytic dataset.
