...
A single world intervention graph (SWIG) (@fig-fullly-connected-swig) is a graph whose nodes represent the variables in a counterfactual non-parametric structural equation model with independent errors (@eq-fullly-connected-swig). Directed edges point from the arguments to the result of each structural equation. 
