...
In the next few sections, we will use this example to discuss model restrictions under classical causal inference. Before we continue, however, we give a high-level overview of the non-parametric structural equation model with independent errors (NPSEM-IE) and of d-separation. Readers who are familiar with these topics may skip to @sec-assumptions-classic.
