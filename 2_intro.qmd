...
The official data used to understand the size and speed of the outbreak came from a diagnostic system that was slow, limited in capacity, and not built for rapid community-level surveillance. Early in the outbreak, testing for mpox could only be performed in specialized public-health laboratories using CDC’s Non-variola Orthopoxvirus PCR assay. Clinicians often had to coordinate with the local health department before collecting specimens, and testing generally required visible lesions to be present.
...
At the same time, the United States entered the outbreak with a **severe vaccine shortage**. When the first U.S. cases were detected, the Strategic National Stockpile had **only about 2,400 immediately deployable doses of JYNNEOS**, the preferred vaccine. Additional doses existed in bulk but required “fill-and-finish” processing before they could be used. By contrast, the estimated size of the U.S. population at elevated risk — men who have sex with men meeting HIV PrEP indications plus MSM living with HIV — was eventually estimated at **roughly 1.6 to 2 million people**. It was clear that vaccine rationing would become necessary, and equally clear that the data needed to support those decisions were limited and slow.
...
Public explanations often cast the outbreak as a product of the “dense sexual networks” of gay and bisexual men, but at the time there were no empirical studies characterizing these networks or explaining how their structure shaped epidemic dynamics. We sought to provide an evidence-based alternative — one that would help community members and public-health officials think through their options using data that reflected how we actually live, move, and connect.
