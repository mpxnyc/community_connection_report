...
ggplot2::ggplot() + 
 ggplot2::theme_void() +
ggplot2::geom_point(ggplot2::aes(x = 1, y = 1), size = 80, color = light_purple, alpha = 0.1) +
    ggimage::geom_image(ggplot2::aes(image=targets::tar_read(mpxnyc_emojis)[["pignose"]], x = 1, y = 1), size = 0.4) 
