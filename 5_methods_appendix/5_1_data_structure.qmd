...
```{r fig.cap=get_figure_details("fig-example-bipartite"), label="fig-example-bipartite"}
...
```{r fig.cap=get_figure_details("fig-example-participant"), label="fig-example-participant"}
#| fig-width: 8
#| fig-height: 5
...
```{r fig.cap=get_figure_details("fig-example-community"), label="fig-example-community"}
#| fig-width: 8
#| fig-height: 5
