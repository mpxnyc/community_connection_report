...
```{r fig.cap=get_figure_details("fig-data"), label="fig-data"}
...
```{r fig.cap=get_figure_details("fig-data-people"), label="fig-data-people"}
#| fig-width: 8
#| fig-height: 5
...
```{r fig.cap=get_figure_details("fig-data-places"), label="fig-data-places"}
#| fig-width: 8
#| fig-height: 5
