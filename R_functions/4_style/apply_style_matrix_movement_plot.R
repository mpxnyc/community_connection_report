apply_style_matrix_movement <- function(plot, caption_hjust = 0){
  ...
  dark_brown          <- mpxnyc_colors[["dark_brown"]]
  ...
  plot +
    ...
    ggplot2::scale_fill_manual("Home borough", values = c(dark_blue, dark_pink, dark_purple, dark_green, dark_brown)) +
    ggplot2::scale_color_manual( "Contact venue\nborough", values = c(dark_blue, dark_pink, dark_purple, dark_green, dark_brown)) +
