program_swing_random              <- function(){
  ...
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "t1", label = r"($t_{1}$)", x = 3, y = 4, node_type = "Community", node_shape = "intervention")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "M1", label = r"($M_{1}$)", x = 4, y = 6, node_type = "Individual", node_shape = "covariate")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "V1", label = r"($V_{1}$)", x = 5, y = 8, node_type = "Individual", node_shape = "covariate")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "R2", label = r"($R_{2}$)", x = 6, y = 2, node_type = "Community", node_shape = "covariate")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "T2", label = r"($T_{2}$)", x = 7, y = 4, node_type = "Community", node_shape = "preintervention")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "t2", label = r"($t_{2}$)", x = 7, y = 4, node_type = "Community", node_shape = "intervention")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "M2", label = r"($M_{2}$)", x = 8, y = 6, node_type = "Individual", node_shape = "covariate")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "V2", label = r"($V_{2}$)", x = 9, y = 8, node_type = "Individual", node_shape = "covariate")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "R3", label = r"($R_{3}$)", x = 10, y = 2, node_type = "Community", node_shape = "covariate")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "T3", label = r"($T_{3}$)", x = 11, y = 4, node_type = "Community", node_shape = "preintervention")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "t3", label = r"($t_{3}$)", x = 11, y = 4, node_type = "Community", node_shape = "intervention")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "M3", label = r"($M_{3}$)", x = 12, y = 6, node_type = "Individual", node_shape = "covariate")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "V3", label = r"($V_{3}$)", x = 13, y = 8, node_type = "Individual", node_shape = "covariate")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "G0", label = r"($\Psi_{0}$)", x = 2, y = 10, node_type = "Graph", node_shape = "covariate")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "G1", label = r"($\Psi_{1}$)", x = 6, y = 10, node_type = "Graph", node_shape = "covariate")
  list_nodes[[length(list_nodes) + 1]] <- data.frame(name = "G2", label = r"($\Psi_{2}$)", x = 10, y = 10, node_type = "Graph", node_shape = "covariate")
