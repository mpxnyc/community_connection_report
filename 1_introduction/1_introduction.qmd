...
-   Group sex is an important driver of MPOX, and might be an important driver of extant epidemics of syphillis, HIV, and other sexually transmitted infections among sexual and gender minorities

-   Since all sex must happen at a commonly occupied physical location, the movement of individuals across psychical space is a necessary condition for an outbreak to happen.

-   Therefore, patterns of movement across the city determine the spatial epidemiology of any infectious disease.

-   The MPX NYC survey is a project of the RESPND-MI study. RESPND-MI is a collective of activists and researchers which formed to respond to the 2022 novel outbreak of MPOX among sexual and gender minority individuals across the world.

## Spatial epidemiology 

-   Spatial epidemiologic studies often only consider residence whereas sex happens at other locations as well.

-   One past study asked about significant locations using cross streets. Otherwise studies tend to use zip code or address. These may not be available or may be secret.

-   We introduce the map-input question format we designed, tested and implemented for the MPX NYC study, which advances methods for measuring spatial data

## Sexual networks and health

-   studies with measured social networks are mostly egocentric - does not allow for measurement of network structure, only perceptions of network structure

-   studies that consider sociocentric networks are mostly simulated - network structure is posited by the researcher and not verifiable

-   our study measures a sociocentric network indirectly and uses a novel measure - the spatial mixing coefficient to quantify spatial clustering
