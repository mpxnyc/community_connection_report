...
In addition, there is endless potential for constructing causal queries about characteristics that cannot be represented as node attributes but rather as emergent properties of the network. We investigate such a query in @sec-causal-interpretation, but before that develop some tools for decribing network data in @sec-appendix-analysis.
