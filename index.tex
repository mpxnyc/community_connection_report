...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, enhanced, borderline west={3pt}{0pt}{shadecolor}, frame hidden, boxrule=0pt, breakable, sharp corners]}{\end{tcolorbox}}\fi
...
\FunctionTok{make\_plotdata\_placetype\_bar\_grid}\NormalTok{() }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{plot\_bar\_stratified}\NormalTok{() }\SpecialCharTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_1}\NormalTok{(demo\_group) }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{  ggplot2}\SpecialCharTok{::}\FunctionTok{scale\_y\_continuous}\NormalTok{(}\StringTok{"MPX NYC sample proportion"}\NormalTok{, }\AttributeTok{labels =}\NormalTok{ scales}\SpecialCharTok{::}\NormalTok{percent) }\SpecialCharTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_1}\NormalTok{(age) }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_1}\NormalTok{(channel) }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_1}\NormalTok{(genderId) }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_1}\NormalTok{(race) }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_1}\NormalTok{(sexOrientation) }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_1}\NormalTok{(groupSex) }\SpecialCharTok{|\textgreater{}} 
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_2}\NormalTok{(sexOrientation, demo\_group) }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_2}\NormalTok{(monkeypoxVaccine, demo\_group) }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_2}\NormalTok{(hivPrep, demo\_group) }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_2}\NormalTok{(placeType, placeSex, }\AttributeTok{person\_analysis =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{  ggplot2}\SpecialCharTok{::}\FunctionTok{coord\_radial}\NormalTok{()  }\SpecialCharTok{+}
\NormalTok{  ggplot2}\SpecialCharTok{::}\FunctionTok{scale\_x\_discrete}\NormalTok{(}\AttributeTok{position =} \StringTok{"top"}\NormalTok{) }\SpecialCharTok{+}
\NormalTok{  ggplot2}\SpecialCharTok{::}\FunctionTok{scale\_y\_continuous}\NormalTok{(}\AttributeTok{labels =} \ControlFlowTok{function}\NormalTok{(x) scales}\SpecialCharTok{::}\FunctionTok{percent}\NormalTok{(}\FunctionTok{abs}\NormalTok{(x))) }\SpecialCharTok{+}
  \FunctionTok{scale\_fill\_mpxnyc}\NormalTok{(}\AttributeTok{name =} \StringTok{""}\NormalTok{) }\SpecialCharTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_2}\NormalTok{(placeType, distanceFromHome, }\AttributeTok{person\_analysis =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{prepare\_table\_3}\NormalTok{( placeType, distanceFromHome, placeSex, }\AttributeTok{person\_analysis =} \ConstantTok{FALSE}\NormalTok{)  }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{  ggplot2}\SpecialCharTok{::}\FunctionTok{coord\_radial}\NormalTok{()  }\SpecialCharTok{+}
  \FunctionTok{scale\_fill\_mpxnyc}\NormalTok{(}\AttributeTok{name =} \StringTok{""}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_mpxnyc\_radar\_places}\NormalTok{() }\SpecialCharTok{+}
\NormalTok{ ggplot2}\SpecialCharTok{::}\FunctionTok{theme}\NormalTok{(}
   \AttributeTok{axis.text.x =}\NormalTok{ ggplot2}\SpecialCharTok{::}\FunctionTok{element\_blank}\NormalTok{()}
\NormalTok{   ) }\SpecialCharTok{+}
\NormalTok{    ggplot2}\SpecialCharTok{::}\FunctionTok{ylim}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\FloatTok{0.2}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
for MPX NYC participants by race-gende}
