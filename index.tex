...
\caption{\label{tbl-gendermodality}\_construction of gender modality
variable}
...
\section{Outbreak control strategies}\label{outbreak-control-strategies}
...
\caption{\label{tbl-demographics}Participants in MPX NYC Study by Sex /
Physical Contact in Congregate Setting in past 4 weeks}
...
\cmidrule(lr){2-4}
\textbf{Variable} & \textbf{Yes}  N = 530\textsuperscript{\textit{1}} & \textbf{No}  N = 774\textsuperscript{\textit{1}} & \textbf{Overall}  N = 1,304\textsuperscript{\textit{1}} & \textbf{p-value} \\ 
\midrule\addlinespace[2.5pt]
{\bfseries Age} &  &  &  &  \\ 
...
\caption{\label{tbl-connection}Participants in MPX NYC Study by Sex /
Physical Contact in Congregate Setting in past 4 weeks}
...
{\bfseries Recent individual sex contacts} &  &  &  &  \\ 
...
\caption{\label{tbl-health}Participants in MPX NYC Study by Sex /
Physical Contact in Congregate Setting in past 4 weeks}
...
{\bfseries HIV supressed} &  &  &  &  \\ 
    Yes & 54 (90\%) & 78 (95\%) & 132 (93\%) &  \\ 
    No & 3 (5.0\%) & 4 (4.9\%) & 7 (4.9\%) &  \\ 
    Unsure & 3 (5.0\%) & 0 (0\%) & 3 (2.1\%) &  \\ 
    Unknown & 470 & 692 & 1,162 &  \\ 
{\bfseries Any STI symptoms} & 118 (22\%) & 93 (12\%) & 211 (16\%) &  \\ 
{\bfseries PrEP user} & 252 (48\%) & 253 (33\%) & 505 (39\%) &  \\ 
{\bfseries MPOX tested} & 58 (11\%) & 47 (6.1\%) & 105 (8.1\%) &  \\ 
{\bfseries MPOX vaccinated} & 409 (77\%) & 461 (60\%) & 870 (67\%) &  \\ 
\bottomrule
\end{tabular*}
\begin{minipage}{\linewidth}
\textsuperscript{\textit{1}}n (\%)\\
...
\caption{\label{tbl-recruitment}Participants in MPX NYC Study by Sex /
Physical Contact in Congregate Setting in past 4 weeks}
...
\caption{\label{tbl-places-descriptives}Contact venue by venue and
contact type}
...
\toprule
 & \multicolumn{3}{c}{\textbf{Physical or sexual contact in group setting in past 4 weeks}} &  \\ 
\cmidrule(lr){2-4}
\textbf{Variable} & \textbf{Did not have sex}  N = 264\textsuperscript{\textit{1}} & \textbf{Had sex}  N = 352\textsuperscript{\textit{1}} & \textbf{Overall}  N = 616\textsuperscript{\textit{1}} & \textbf{p-value} \\ 
\midrule\addlinespace[2.5pt]
{\bfseries Place type} &  &  &  &  \\ 
...
\bibitem[\citeproctext]{ref-annagracelee}
...
\bibitem[\citeproctext]{ref-aronow2017}
...
\bibitem[\citeproctext]{ref-blackburn2022}
...
\bibitem[\citeproctext]{ref-hernuxe1n2018}
Hernán, Miguel, and James M. Robins. 2018. \emph{Causal inference}.
Chapman \& Hall/CRC monographs on statistics \& applied probability.
Chapman \& Hall/CRC.

\bibitem[\citeproctext]{ref-krellenstein2023}
...
\bibitem[\citeproctext]{ref-kyaw2022}
...
\bibitem[\citeproctext]{ref-minhaj2022}
...
\bibitem[\citeproctext]{ref-neo4j2024}
...
\bibitem[\citeproctext]{ref-roth2023}
...
\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}rll}
\toprule
From & To & Relation \\ 
\midrule\addlinespace[2.5pt]
1 & A & HOME \\ 
...
\caption{\label{tbl-example-place-nodes}Sample place network data}
...
\subsubsection{Participant social reach}\label{participant-social-reach}
...
\begin{equation}\phantomsection\label{eq-fullly-connected-dag}{
\begin{aligned}
L_1 &= f_{L_1}(U_{L_1}) \\
...
\begin{equation}\phantomsection\label{eq-no-spillover-dag}{
\begin{aligned}
L_1 &= f_{L_1}(U_{L_1}) \\
L_2 &= f_{L_2}(U_{L_2}) \\
L_3 &= f_{L_3}(U_{L_3} ) \\
...
\begin{equation}\phantomsection\label{eq-independence-dag}{
\begin{aligned}
L_i &= f_{L}( U_{L_i}) \\
A_i &= f_{A}( U_{A_i}, L_i) \\
...
\begin{equation}\phantomsection\label{eq-independence-swig}{
\begin{aligned}
L_i &= f_{L}( U_{L_i}                       ) \\
A_i &= f_{A}( U_{A_i}, L_i) \\
...
\subsubsection{Independence assumptions}\label{independence-assumptions}
...
\begin{equation}\phantomsection\label{eq-interference-dag}{
\begin{aligned}
L_1 &= f_{L_1}(U_{L_1}) \\
L_2 &= f_{L_2}(U_{L_2}) \\
L_3 &= f_{L_3}(U_{L_3} ) \\
...
\begin{equation}\phantomsection\label{eq-homogenous-dag}{
\begin{aligned}
L_i &= f_{L}( U_{L_i} ) \\
...
\begin{equation}\phantomsection\label{eq-homogenous-interference-swig}{
\begin{aligned}
L_i &= f_{L}(  U_{L_i}  ) \\
...
\subsubsection{Homogeneity assumptions}\label{homogeneity-assumptions-1}
...
\begin{equation}\phantomsection\label{eq-placeintervention-dang}{
\begin{aligned}
...
\begin{equation}\phantomsection\label{eq-placeintervention-swing}{
\begin{aligned}
M_{0i} &=  f_{M_0}(U_{M_{0i}}) \\
V_{0i} &=  f_{V_0}(U_{V_{0i}}) \\
...
\begin{equation}\phantomsection\label{eq-edge-intervention-swing}{
\begin{aligned}
M_{0i} &=  0 \\
V_{0i} &=  0 \\
...
\section{Presentations and workshops}\label{presentations-and-workshops}
