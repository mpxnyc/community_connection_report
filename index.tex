...
{\centering \includegraphics{3_results/3_1__results_participants_files/figure-pdf/unnamed-chunk-7-1.pdf}
...
{\centering \includegraphics{D_survey_instrument/D__survey_instrument_files/figure-pdf/unnamed-chunk-2-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{targets}\SpecialCharTok{::}\FunctionTok{tar\_source}\NormalTok{(}\AttributeTok{files =} \StringTok{"/Users/keletso/Documents/\_gitrepos/mpxnyc\_data\_analysis/R\_functions"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{captions\_and\_titles }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(figure\_name)\{}
  
   
  
\NormalTok{    list\_captions\_and\_titles }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"common\_caption"}\NormalTok{]] }\OtherTok{\textless{}{-}} \StringTok{"Data source: MPX NYC Survey (restricted to 1,304 residents of New York City). www.mpxresponse.org"}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_group\_sex"}\NormalTok{]]                          }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_group\_sex"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]               }\OtherTok{\textless{}{-}} \StringTok{"Figure 1. Social or sexual contact in group setting over prior four weeks"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_group\_sex"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]            }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_group\_sex"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]             }\OtherTok{\textless{}{-}} \StringTok{"Participants were asked whether they \textquotesingle{}had sex with two or more people at the same time or had close, physical contact with multiple people at the same time (e.g. at a party, sport game, concert, show)\textquotesingle{} over the prior four weeks. About two fifths responded yes."}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_placesex"}\NormalTok{]]                       }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_placesex"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]            }\OtherTok{\textless{}{-}} \StringTok{"Figure 2. Type of venue for contact vs. type of contact"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_placesex"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]         }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_placesex"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]          }\OtherTok{\textless{}{-}} \StringTok{"We asked participants to show the location of their home and the locations of places where they had close, physical contact in a group setting. For each place, they indicated what kind of venue it was and whether they had sexual contact there. Among places where participants did not have sex, most were public settings. By contrast, the majority of places for sexual contact were private residences."}
    
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_distance"}\NormalTok{]]                         }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_distance"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]              }\OtherTok{\textless{}{-}} \StringTok{"Figure 3. Type of venue for contact vs. distance from home"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_distance"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]           }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_distance"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]            }\OtherTok{\textless{}{-}} \StringTok{"We asked participants to show the location of their home and the locations of places where they had close, physical contact in a group setting. For each place, they indicated what kind of venue it was and whether they had sexual contact there. The further away from home a place was, the less likely it was to be a private residence and the more likely it was to be a dance party."}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_sex\_distance"}\NormalTok{]]                }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_sex\_distance"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]     }\OtherTok{\textless{}{-}} \StringTok{"Figure 4. Type of venue for contact vs. type of contact and distance from home"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_sex\_distance"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]  }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_placetype\_sex\_distance"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]   }\OtherTok{\textless{}{-}} \StringTok{"We asked participants to show the location of their home and the locations of places where they had close, physical contact in a group setting. For each place, they indicated what kind of venue it was and whether they had sexual contact there. Among places for sexual contact, the further away from home a place was, the less likely it was to be a private residence. At each distance, however, private residencs were the predominant venue for sexual contact."}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"map\_coverage"}\NormalTok{]]                          }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"map\_coverage"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]               }\OtherTok{\textless{}{-}} \StringTok{"Figure 5. Large number of individuals reachable in limited geographic area"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"map\_coverage"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]            }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"map\_coverage"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]             }\OtherTok{\textless{}{-}} \StringTok{"It may be possible to mount geographically targeted interventions that have impact across New York City. We ranked community districts in terms of the number of participants who reside or reported close, physical contact in them. The top five community districts (which comprise Group A) together account for about one third of participants. The next eight community districts (Group B) account for another third of participants."}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"matrix\_places"}\NormalTok{]]                      }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"matrix\_places"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]           }\OtherTok{\textless{}{-}} \StringTok{"Figure 6. Movement between community districts in New York City"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"matrix\_places"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]        }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"matrix\_places"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]         }\OtherTok{\textless{}{-}} \StringTok{"We asked participants to show the location of their home and the locations of places where they had close, physical contact in a group setting. The axis on the left shows the home community district of each participant, and the top axis shows the destination community. The size of each circle is proportional to the number of respondents with a home in the community on the left who had contact in a community showed at the top."}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"networkcoverage"}\NormalTok{]]                         }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"networkcoverage"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]              }\OtherTok{\textless{}{-}} \StringTok{"Figure 7. Community districts densely connected"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"networkcoverage"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]           }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"networkcoverage"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]            }\OtherTok{\textless{}{-}} \StringTok{"We asked participants to show the location of their home and the locations of places where they had close, physical contact in a group setting. We constructed a network where nodes are community districts. A tie between a given pair of nodes indicates that at least one study participant was present in both community districts. The thickness of the tie is proportional to the number of study participants who have been present in both community districts."}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_demo\_group"}\NormalTok{]]                 }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_demo\_group"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]      }\OtherTok{\textless{}{-}} \StringTok{"Figure 8. Race and gender of participants"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_demo\_group"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]   }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_demo\_group"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]    }\OtherTok{\textless{}{-}} \StringTok{""}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_age"}\NormalTok{]]                 }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_age"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]      }\OtherTok{\textless{}{-}} \StringTok{"Figure 9. Age of participants"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_age"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]   }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_age"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]    }\OtherTok{\textless{}{-}} \StringTok{""}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_channel"}\NormalTok{]]                 }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_channel"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]      }\OtherTok{\textless{}{-}} \StringTok{"Figure 10. Study recruitment channel"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_channel"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]   }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_channel"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]    }\OtherTok{\textless{}{-}} \StringTok{""}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_gender"}\NormalTok{]]                 }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_gender"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]      }\OtherTok{\textless{}{-}} \StringTok{"Figure 11. Gender identity of participants"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_gender"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]   }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_gender"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]    }\OtherTok{\textless{}{-}} \StringTok{""}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_race"}\NormalTok{]]                 }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_race"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]      }\OtherTok{\textless{}{-}} \StringTok{"Figure 12. Race of participants"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_race"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]   }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_race"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]    }\OtherTok{\textless{}{-}} \StringTok{""}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_sex\_orientation"}\NormalTok{]]                 }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_sex\_orientation"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]      }\OtherTok{\textless{}{-}} \StringTok{"Figure 13. Sexual orientation of participants"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_sex\_orientation"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]   }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"bar\_sex\_orientation"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]    }\OtherTok{\textless{}{-}} \StringTok{""}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"demogroupa"}\NormalTok{]]                 }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"demogroupa"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]      }\OtherTok{\textless{}{-}} \StringTok{"Figure 14a. Demographic characteristics of participants"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"demogroupa"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]   }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"demogroupa"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]    }\OtherTok{\textless{}{-}} \StringTok{""}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"demogroupb"}\NormalTok{]]                 }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"demogroupb"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]      }\OtherTok{\textless{}{-}} \StringTok{"Figure 14b. Demographic characteristics of participants"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"demogroupb"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]   }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov. 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"demogroupb"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]    }\OtherTok{\textless{}{-}} \StringTok{""}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_sexOrientation\_demo\_group"}\NormalTok{]]                         }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_sexOrientation\_demo\_group"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]              }\OtherTok{\textless{}{-}} \StringTok{"Sexual Orientation by Race{-}Gender"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_sexOrientation\_demo\_group"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]           }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_sexOrientation\_demo\_group"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]            }\OtherTok{\textless{}{-}} \StringTok{""}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_hivPrep\_demo\_group"}\NormalTok{]]                         }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_hivPrep\_demo\_group"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]              }\OtherTok{\textless{}{-}} \StringTok{"HIV/PreP Status by Race{-}Gender"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_hivPrep\_demo\_group"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]           }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_hivPrep\_demo\_group"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]            }\OtherTok{\textless{}{-}} \StringTok{""}
    
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_monkeypoxVaccine\_demo\_group"}\NormalTok{]]                         }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{()}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_monkeypoxVaccine\_demo\_group"}\NormalTok{]][[}\StringTok{"title"}\NormalTok{]]              }\OtherTok{\textless{}{-}} \StringTok{"MPOX Vaccination Status by Race{-}Gender"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_monkeypoxVaccine\_demo\_group"}\NormalTok{]][[}\StringTok{"subtitle"}\NormalTok{]]           }\OtherTok{\textless{}{-}} \StringTok{"New York, United States, Aug. {-} Nov 2022"}
\NormalTok{    list\_captions\_and\_titles[[}\StringTok{"radar\_monkeypoxVaccine\_demo\_group"}\NormalTok{]][[}\StringTok{"caption"}\NormalTok{]]            }\OtherTok{\textless{}{-}} \StringTok{""}
    
    
    
\NormalTok{    list\_captions\_and\_titles[[figure\_name]]}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_bar_demogroup-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{draw\_table\_1}\NormalTok{(demo\_group, }\StringTok{"Race{-}Gender"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_bar_age-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{draw\_table\_1}\NormalTok{(age, }\StringTok{"Age"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_bar_channel-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{draw\_table\_1}\NormalTok{(channel, }\StringTok{"Channel"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_bar_gender-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{draw\_table\_1}\NormalTok{(genderId, }\StringTok{"Gender"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_bar_race-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{draw\_table\_1}\NormalTok{(race, }\StringTok{"Race"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_bar_sexorientation-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{draw\_table\_1}\NormalTok{(sexOrientation, }\StringTok{"Sexual Orientation"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{make\_table\_freq2}\NormalTok{(sexOrientation, demo\_group) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{plot\_radar\_grid}\NormalTok{() }
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_radar_grid_sexOrientation_demo_group-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{draw\_table\_2}\NormalTok{(sexOrientation, demo\_group, }\StringTok{"Sexual Orientation by Race{-}Gender"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_radar_grid_monkeypoxVaccine_demo_group-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{draw\_table\_2}\NormalTok{(monkeypoxVaccine, demo\_group, }\StringTok{"Mpox Vax Status by Race{-}Gender"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_radar_grid_hivPrep_demo_group-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{draw\_table\_2}\NormalTok{(hivPrep, demo\_group, }\StringTok{"HIV and PrEP Status by Race{-}Gender"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_bar_groupsex-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{draw\_table\_1}\NormalTok{(groupSex, }\StringTok{"Group Sex / Contact past 4 weeks"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mpxnyc\_colors }\OtherTok{\textless{}{-}}\NormalTok{ mpxnyc}\SpecialCharTok{::}\NormalTok{mpxnyc\_colors}
\FunctionTok{attach}\NormalTok{(mpxnyc\_colors)}
\NormalTok{targets}\SpecialCharTok{::}\FunctionTok{tar\_source}\NormalTok{(}\AttributeTok{files =} \StringTok{"/Users/keletso/Documents/\_gitrepos/mpxnyc\_data\_analysis/R\_functions"}\NormalTok{)}
...
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(level)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{plot\_radar\_stratified}\NormalTok{() }
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_radar_facet_placetype_placesex-1.pdf}
...
\begin{Highlighting}[]
\FunctionTok{make\_table\_freq2}\NormalTok{(placeType, placeSex, }\AttributeTok{person\_analysis =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
        \FunctionTok{draw\_table\_stratified}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\midrule\addlinespace[2.5pt]
Concert/Theatre/Show & 63 & 24 (20 to 28) \\ 
Dance Party & 110 & 42 (34 to 50) \\ 
Dark Room/Sex Party & 10 & 4 (2 to 6) \\ 
Private Residence & 28 & 10 (10 to 14) \\ 
Something Else & 40 & 16 (10 to 20) \\ 
Sport Game & 13 & 4 (4 to 8) \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{l}{Had sex} \\ 
\midrule\addlinespace[2.5pt]
Concert/Theatre/Show & 4 & 2 (0 to 2) \\ 
Dance Party & 33 & 10 (8 to 12) \\ 
Dark Room/Sex Party & 52 & 14 (10 to 16) \\ 
Private Residence & 222 & 64 (60 to 64) \\ 
Something Else & 40 & 12 (10 to 14) \\ 
Sport Game & 1 & 0 (0 to 0) \\ 
\bottomrule
\end{longtable*}
...
{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_radar_facet_placetype_distancefromhome-1.pdf}
...
\midrule\addlinespace[2.5pt]
Concert/Theatre/Show & 26 & 12 (10 to 16) \\ 
Dance Party & 64 & 32 (28 to 36) \\ 
Dark Room/Sex Party & 29 & 14 (12 to 22) \\ 
Private Residence & 47 & 24 (16 to 28) \\ 
Something Else & 25 & 12 (10 to 16) \\ 
Sport Game & 9 & 4 (4 to 8) \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{l}{Same Borough} \\ 
\midrule\addlinespace[2.5pt]
Concert/Theatre/Show & 36 & 16 (10 to 20) \\ 
Dance Party & 56 & 24 (22 to 30) \\ 
Dark Room/Sex Party & 22 & 10 (6 to 10) \\ 
Private Residence & 73 & 32 (30 to 38) \\ 
Something Else & 39 & 16 (14 to 20) \\ 
Sport Game & 4 & 2 (0 to 2) \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{l}{Same Community District} \\ 
\midrule\addlinespace[2.5pt]
Concert/Theatre/Show & 5 & 2 (2 to 6) \\ 
Dance Party & 23 & 12 (8 to 16) \\ 
Dark Room/Sex Party & 11 & 6 (4 to 8) \\ 
Private Residence & 130 & 70 (68 to 76) \\ 
Something Else & 16 & 8 (6 to 10) \\ 
Sport Game & 1 & 0 (0 to 0) \\ 
\bottomrule
\end{longtable*}
...
\begin{Shaded}
\begin{Highlighting}[]
  \FunctionTok{make\_table\_freq3}\NormalTok{(placeType, placeSex, distanceFromHome, }\AttributeTok{person\_analysis =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
\NormalTok{    dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(level)) }\SpecialCharTok{|\textgreater{}}
  \FunctionTok{plot\_radar\_stratified2}\NormalTok{() }
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{6_results_appendix/6_results_appendix_files/figure-pdf/plot_radar_facet_placetype_placesex_distancefromhome-1.pdf}
...
\begin{Highlighting}[]
  \FunctionTok{make\_table\_freq3}\NormalTok{(placeType, placeSex, distanceFromHome, }\AttributeTok{person\_analysis =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{draw\_table\_stratified2}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
Group & N & \% (95\% CI) \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{l}{Did not have sex - Different Borough} \\ 
\midrule\addlinespace[2.5pt]
Concert/Theatre/Show & 23 & 22 (18 to 22) \\ 
Dance Party & 50 & 48 (42 to 52) \\ 
Dark Room/Sex Party & 4 & 4 (4 to 10) \\ 
Private Residence & 8 & 8 (4 to 12) \\ 
Something Else & 13 & 12 (8 to 16) \\ 
Sport Game & 8 & 8 (6 to 12) \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{l}{Did not have sex - Same Borough} \\ 
\midrule\addlinespace[2.5pt]
Concert/Theatre/Show & 35 & 30 (20 to 36) \\ 
Dance Party & 43 & 38 (30 to 48) \\ 
Dark Room/Sex Party & 3 & 2 (2 to 4) \\ 
Private Residence & 10 & 8 (8 to 14) \\ 
Something Else & 21 & 18 (10 to 24) \\ 
Sport Game & 4 & 4 (2 to 6) \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{l}{Did not have sex - Same Community District} \\ 
\midrule\addlinespace[2.5pt]
Concert/Theatre/Show & 5 & 12 (6 to 24) \\ 
Dance Party & 17 & 40 (28 to 56) \\ 
Dark Room/Sex Party & 3 & 8 (2 to 12) \\ 
Private Residence & 10 & 24 (18 to 40) \\ 
Something Else & 6 & 14 (8 to 16) \\ 
Sport Game & 1 & 2 (2 to 2) \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{l}{Had sex - Different Borough} \\ 
\midrule\addlinespace[2.5pt]
Concert/Theatre/Show & 3 & 4 (0 to 6) \\ 
Dance Party & 14 & 14 (12 to 22) \\ 
Dark Room/Sex Party & 25 & 26 (20 to 36) \\ 
Private Residence & 39 & 42 (28 to 44) \\ 
Something Else & 12 & 12 (8 to 22) \\ 
Sport Game & 1 & 2 (0 to 4) \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{l}{Had sex - Same Borough} \\ 
\midrule\addlinespace[2.5pt]
Concert/Theatre/Show & 1 & 0 (0 to 2) \\ 
Dance Party & 13 & 12 (8 to 16) \\ 
Dark Room/Sex Party & 19 & 16 (8 to 16) \\ 
Private Residence & 63 & 56 (52 to 62) \\ 
Something Else & 18 & 16 (14 to 18) \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{l}{Had sex - Same Community District} \\ 
\midrule\addlinespace[2.5pt]
Dance Party & 6 & 4 (2 to 4) \\ 
Dark Room/Sex Party & 8 & 6 (4 to 8) \\ 
Private Residence & 120 & 84 (82 to 86) \\ 
Something Else & 10 & 6 (4 to 10) \\ 
\bottomrule
\end{longtable*}
