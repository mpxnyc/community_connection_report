...
ggplot2::geom_point(ggplot2::aes(x = 1, y = 1), size = 80, color = light_purple, shape = 3) +
    ggimage::geom_image(ggplot2::aes(image=targets::tar_read(mpxnyc_emojis)[["taco"]], x = 1, y = 1), size = 0.4) 
...
```{r tbl_places_descriptives, echo = FALSE, message = FALSE, warning=FALSE}
...
```{r fig_places_distance_sexcontact, echo = FALSE, message = FALSE, warning=FALSE}
