...
#| fig-align: center
  ...
  light_purple    <- mpxnyc_colors[["light_orange"]]

  
ggplot2::ggplot() + 
 ggplot2::theme_void() +
ggplot2::geom_point(ggplot2::aes(x = 1, y = 1), size = 80, color = light_purple, shape = 3) +
    ggimage::geom_image(ggplot2::aes(image=targets::tar_read(mpxnyc_emojis)[["peach"]], x = 1, y = 1), size = 0.4) 
...
```{r tbl_people_descriptives, echo = FALSE, warning = FALSE, message=FALSE}
...
```{r fig_sex_orientation_racegender, echo = FALSE, warning = FALSE, message=FALSE}
