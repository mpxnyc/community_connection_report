...
Figure 11.3 shows how these strategies affect network connectivity. Before any intervention, nearly every participant belonged to a single large connected component, meaning potential transmission paths linked most of the population. As immunization expanded, this component fragmented—more sharply under the movement-neutralizing approach than under the contact-based one.
...
Figure 11.1 High-coverage community districts under contact- vs movement-neutralizing strategies (33 % coverage).  
Figure 11.2 High-coverage community districts under both strategies (66 % coverage).  
Figure 11.3 Network connectivity after sequential immunization, comparing the two strategies.
