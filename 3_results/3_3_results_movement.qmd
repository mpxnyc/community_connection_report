...
```{r fig.cap=get_figure_details("fig-communities-movement"), label="fig-communities-movement"}
#| fig-width: 10
#| fig-height: 10
...
```{r fig.cap=get_figure_details("fig-communities-bar"), label="fig-communities-bar"}
#| fig-width: 10
#| fig-height: 7
...
```{r fig.cap=get_figure_details("fig-demogroup-mixing"), label="fig-demogroup-mixing"}
#| fig-width: 9
#| fig-height: 9
...
```{r fig.cap=get_figure_details("fig-sexorientation-mixing"), label="fig-sexorientation-mixing"}
#| fig-width: 6
#| fig-height: 5
#| 
...
```{r fig.cap=get_figure_details("fig-age-mixing"), label="fig-age-mixing"}
#| fig-width: 6
#| fig-height: 6
...
```{r fig.cap=get_figure_details("fig-subgroup-mixing"), label="fig-subgroup-mixing"}
#| fig-width: 12
#| fig-height: 17
#| 
