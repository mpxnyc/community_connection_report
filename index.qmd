...
# Home {.unnumbered .hidden}

:::: {.p-5 .pt-1 .mb-4 .rounded-3 .shadow-sm .hero-banner .centered layout-align="center"}
# Community and Connection {.unnumbered}

Comprehensive report for MPX NYC — a rapid, community-led study of mpox, networks, and care built by queer and trans New Yorkers, for queer and trans New Yorkers.
...
The MPS NYC advocacy team’s advocacy and research efforts have been shared throgh major media outlets: ***The New York Times,** The Atlantic, TIME, PBS NewsHour, CBS News, NPR, The Washington Post,* and ***STAT**,* as well as queer media such as ***The Body*** **and *POZ Magazine.*** International coverage in *P**LOS Global Public Health**, Out,* and *The Sunday Times* further extended the reach.
...
This website was developed through **CTRL+F**—an LGBTQ+-led consultancy created to be an incubator for creative and urgent research and scholarship. We’re in our infancy and **need all the support we can get**.
...
1.  Write Organizing section
2.  Finish hand editing results
3.  Write discussion
