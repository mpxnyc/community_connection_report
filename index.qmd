...
::: {#acknowledgements}
[Lead author]{.underline}: Keletso Makofane, MPH, PhD. [Editor]{.underline}: Nicholas Diamond, MPH. [Co-authors]{.underline}: Jennifer Barnes-Balenciaga, Elle Lett, MA, MBiostat, PhD, Nguyen Tran, MPH, PhD. 
:::
...
We present these in a framework named Social and Spatial Network Analysis with Causal Interpretation (SSNACC), which we motivate in @sec-appendix-social-spatial and detail in @sec-causal-interpretation. This framework was first presented at the Society for Epidemiologic Research 2025 meeting in Boston in a workshop taught by Aaron Sarviet (University of Massachusetts), Mats Strensaud (École polytechnique fédérale de Lausanne), Keletso Makofane (Ctrl+F), Jamie Robins (Harvard University), and Thomas Richardson (University of Washington).
