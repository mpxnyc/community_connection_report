...
We found that all participants belonged to one interconnected network of people and places. We had a diverse group of participants. 

[**LOCAL = GLOBAL HEALTH ACTIVISM**]{.emphasize}:
The work was conducted under  the Rapid Epidemiologic Study of Sexual Networks, Demography, and Mpox Infection (**RESPND-MI**), an **LGBTQ community-led collaboration** formed during the 2022 mpox outbreak among queer and trans New Yorkers. It convened activists, organizers, and researchers to share information quickly and act. 


[**CAUSAL INFERENCE FOR AN INTERCONNECTED WORLD**]{.emphasize}:
We introduce a framework for causal inference in social and spatial epidemiology called **SSNAC**. SSNAC guides the collection, management, analysis, and causal interpretation of data from complex causal systems using tools that are already widely validated.


[**OPEN SCIENCE**]{.emphasize}:
Along with the study results, we share all the code that generated this book, the MPX NYC person-place network mapper, as well as a detailed set of appendices **for students, data activists, and researchers** who wish to learn and use these methods. 
...
[Data](#sec-data){.btn .btn-sm .btn-outline-secondary} 
[Measures](#sec-measures){.btn .btn-sm .btn-outline-secondary} 
[Analysis](#sec-analysis){.btn .btn-sm .btn-outline-secondary} 
[Measurement](#sec-measurement){.btn .btn-sm .btn-outline-primary} 
...
[Context](#sec-appendix-social-spatial){.btn .btn-sm .btn-outline-primary} 
[Description](#sec-appendix-analysis){.btn .btn-sm .btn-outline-primary} 
[Causality](#sec-causal-interpretation){.btn .btn-sm .btn-outline-primary}
...
[Organizing](#sec-organizing){.btn .btn-sm .btn-outline-primary} 
[Marketing](#sec-marketing){.btn .btn-sm .btn-outline-primary}
:::
::::
...
As support for LGBTQ+ health services and research declines, and thousands of talented queer people are laid off, it is crucial to develop and  

this project shows that **rigorous epidemiology and community organizing can coexist**. Through the weekly **RESPND-MI LGBTQ+ Community Forum**, activists, clinicians, and researchers co-designed the study—refining language to avoid stigma, choosing outreach venues, and building bilingual campaigns.
